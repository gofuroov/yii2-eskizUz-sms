        ...
        <div class="card">
            <div class="card-header d-flex p-0">
                ...
                <ul class="nav nav-pills ml-auto p-2">
                    <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Menyular</a></li>
                    <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">SMS xizmati holati</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?= $form->field($model, 'text')
                    ->textarea(['placeholder' => $model->getAttributeLabel('text'), 'rows' => 4])
